...
class LDL508PROComponent : public Component,
 ...
 public:
  ...
  void set_multitarget_byte_mqtt_topic(const std::string &value) { this->multitarget_byte_mqtt_topic_ = value; }
 ...
 protected:
  ...
  void capture_multitarget_byte_(uint8_t byte, uint32_t now_ms);
  void flush_multitarget_byte_block_();
  ...
  void publish_tracked_snapshot_(uint8_t raw_count, uint32_t now_ms);
  ...
  MultiTargetTracker multi_target_tracker_{};
  ...
  std::string multitarget_byte_mqtt_topic_{};
  ...
  std::array<uint8_t, 128> multitarget_byte_block_{};
  std::array<uint32_t, 128> multitarget_byte_delta_us_{};
  uint16_t multitarget_byte_block_length_{0};
  uint32_t multitarget_byte_first_us_{0};
  uint32_t multitarget_byte_previous_us_{0};
  uint32_t multitarget_byte_last_byte_ms_{0};
  uint32_t multitarget_byte_sequence_{0};
