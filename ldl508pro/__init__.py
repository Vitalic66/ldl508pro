...
CONF_MULTITARGET_BYTE_MQTT_TOPIC = "multitarget_byte_mqtt_topic"
    ...
    cv.Schema(
        {
            ...
            cv.Optional(CONF_MULTITARGET_BYTE_MQTT_TOPIC, default=""): cv.string,
...
async def to_code(config):
    ...
    cg.add(var.set_multitarget_byte_mqtt_topic(config[CONF_MULTITARGET_BYTE_MQTT_TOPIC]))
